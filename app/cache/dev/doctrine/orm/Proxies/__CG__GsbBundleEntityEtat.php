 ...
 */
class Etat extends \GsbBundle\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GsbBundle\\Entity\\Etat' . "\0" . 'idetat', '' . "\0" . 'GsbBundle\\Entity\\Etat' . "\0" . 'alias', '' . "\0" . 'GsbBundle\\Entity\\Etat' . "\0" . 'libelle');
        }

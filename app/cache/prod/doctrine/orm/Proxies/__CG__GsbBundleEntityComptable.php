 ...
 */
class Comptable extends \GsbBundle\Entity\Comptable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GsbBundle\\Entity\\Comptable' . "\0" . 'idcomptable', '' . "\0" . 'GsbBundle\\Entity\\Comptable' . "\0" . 'login', '' . "\0" . 'GsbBundle\\Entity\\Comptable' . "\0" . 'mdp', '' . "\0" . 'GsbBundle\\Entity\\Comptable' . "\0" . 'nom', '' . "\0" . 'GsbBundle\\Entity\\Comptable' . "\0" . 'prenom');
        }
    ...
    public function getIdcomptable()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdcomptable();
        }

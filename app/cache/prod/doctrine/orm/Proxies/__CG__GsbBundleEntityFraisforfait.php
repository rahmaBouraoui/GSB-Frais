 ...
 */
class Fraisforfait extends \GsbBundle\Entity\Fraisforfait implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GsbBundle\\Entity\\Fraisforfait' . "\0" . 'idfrais', '' . "\0" . 'GsbBundle\\Entity\\Fraisforfait' . "\0" . 'alias', '' . "\0" . 'GsbBundle\\Entity\\Fraisforfait' . "\0" . 'libelle', '' . "\0" . 'GsbBundle\\Entity\\Fraisforfait' . "\0" . 'montant');
        }
